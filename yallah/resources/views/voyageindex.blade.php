                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <strong class="card-title">Les voyages ajoutés</strong>
                            </div>
                            </center>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                  <a class="btn btn-success btn-sm" href="{{route('voyage.show',['voyage'=> $voy->id])}}">
                                                    <i class="fa fa-eye"></i>
                                                  </a>
                                                  <a class="btn btn-secondary btn-sm" href="{{url('voyage/'.$voy->id.'/resrvation')}}">
                                                    <i class="fa fa-list"></i>
                                                  </a>
                                                  <a class="btn btn-primary btn-sm" href="{{route('voyage.edit',['voyage'=> $voy->id])}}">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                      <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                          ...
                                                          <form action="{{ route( 'voyage.destroy', ['voyage'=> $voy->id]) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
