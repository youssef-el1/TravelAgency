                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li>voyages</li>
                                    <li class="active">modifier le voyage</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <strong>informations sur le voyage</strong>
                            </div>
                            </center>
                            <div class="card-body card-block">
                                @foreach ($voyages as $voy)
                                <form action="{{route('voyage.update',['voyage'=>$voy->id])}}" method="post"  class="form-horizontal" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="row form-group ">
                                        <div class="col col-md-3"><label for="titre" class=" form-control-label">Titre</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="titre" name="titre" placeholder="Titre" value="{{old('titre',$voy->titre)}}" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="date_dp" class=" form-control-label">Date Depart</label></div>
                                        <div class="col-12 col-md-9"><input type="date" id="date_dp" name="date_dp" value="{{old('date_dp',$voy->date_dp)}}" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="date_ar" class=" form-control-label">Date de Retour</label></div>
                                        <div class="col-12 col-md-9"><input type="date" id="date_ar" name="date_ar"  value="{{old('date_ar',$voy->date_ar)}}" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="durée" class=" form-control-label">Durée</label></div>
                                        <div class="col-12 col-md-4"><input type="number" id="durée" name="duree" placeholder="durée" value="{{old('duree',$voy->duree)}}" class="form-control"></div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="prix" name="prix" placeholder="Prix" value="{{old('prix',$voy->prix)}}"  class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="nbplace" class=" form-control-label">nombre de place</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="nbplace" name="nbplace" placeholder="nbplace" value="{{old('nbplace',$voy->nbplace)}}"  class="form-control"></div>
                                    </div>
                                    @foreach (App\Models\Image::where('idvoyage',$voy->id)->get() as $image)
                                        <div class="row">
                                            <div class="col col-md-4"><img src="{{asset('./uploads/'.$image->path)}}" alt=""></div>
                                            <a class="btn btn-danger btn-sm" style="width: 3cm;height: 1cm" href="{{url('/voyage/'.$image->id.'/destroyimage')}}">
                                                <i class="fa fa-trash">Supprimer</i>
                                            </a>
    
                                    @endforeach
                                    <div class="custom-file col-md-9" style="margin-left: 2cm">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-12"><textarea id="myTextarea"  name="description"   placeholder="..." >
                                        {{old('description',$voy->description)}}
                                        </textarea></div>
                                </div>
