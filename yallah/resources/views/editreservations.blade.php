                    ...
                    <div class="col-lg-10">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                ...
                                <form action="{{route('reservation.update',['reservation'=>$res->id])}}" method="post"  class="form-horizontal" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="row form-group ">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="nom" name="nom" placeholder="nom" value="{{old('date_ar',$res->nom)}}" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="prenom" class=" form-control-label">Prénom</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="prenom" name="prenom" placeholder="prenom" value="{{old('date_ar',$res->prenom)}}"  class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="tele" class=" form-control-label">Numéro de téléphone</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="tele" name="tele" placeholder="Numero de telephone" value="{{old('date_ar',$res->tele)}}" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="nbr_place" class=" form-control-label">Nombre de places</label></div>
                                        <div class="col-12 col-md-9"><input type="number" id="nbr_place" name="nbr_place" placeholder="Nombre de places" value="{{old('date_ar',$res->nbr_place)}}" class="form-control" onclick="getValue()"></div>
                                    </div>
                                    <div class="row form-group">
                    ...
                    <div class="card">
                        <div class="card-body card-block">
                            <div class="card-body " style="margin-left: 20%;">
                                ...
                                <button type="submit" class="btn btn-success col-md-4" style="border-radius: 40px;">Modifier</button>
                            </div>
                            </form>
                            @endforeach
                        </div>
