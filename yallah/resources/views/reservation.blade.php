                                            ...
                                            <td>
                                                <div class="row">
                                                  ...
                                                  <div class="modal fade" id="exampleModalLong{{$res->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                                                    ...
                                                    <form action="{{url('updatestatut/'.$res->id)}}" method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        <input type="hidden" name="statut" value="0">
                                                        <button class="btn btn-secondary btn-sm" type="submit">NV</i></button>
                                                      </form>
                                                    ...
                                                    <form action="{{url('updatestatut/'.$res->id)}}" method="POST">
                                                        ...
                                                        <button class="btn btn-success btn-sm" type="submit">V</button>
                                                    </form>
                                                </div>
                                              </td>
                                        </tr>
